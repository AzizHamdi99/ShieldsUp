...
import {
  ...
  ArrowLeft, Clock, Star, ChevronRight, CheckCircle2,
} from "lucide-react"
        ...
        <div className="mx-auto max-w-4xl px-4 lg:px-8">
          ...
          <div className="mt-6 flex items-start gap-4">
            <div className={cn(
              ...
              category.color === 'cyber-blue' && "bg-primary/10 border-primary/20 text-primary",
              category.color === 'cyber-green' && "bg-cyber-green/10 border-cyber-green/20 text-cyber-green",
              category.color === 'cyber-purple' && "bg-cyber-purple/10 border-cyber-purple/20 text-cyber-purple",
              category.color === 'cyber-pink' && "bg-cyber-pink/10 border-cyber-pink/20 text-cyber-pink",
              category.color === 'cyber-yellow' && "bg-cyber-yellow/10 border-cyber-yellow/20 text-cyber-yellow",
            )}>
              <Icon className="h-7 w-7" />
            </div>
            <div>
              <h1 className="text-2xl font-bold text-foreground lg:text-3xl">{category.name}</h1>
          ...
          <div className="mt-8 flex flex-col gap-4">
            {category.challenges.map((challenge) => {
              ...
              const isCompleted = progress?.completedChallenges.includes(challenge.id) ?? false
